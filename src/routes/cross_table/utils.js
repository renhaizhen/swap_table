...
//         const width = 600;
//         const height = 600;
//         const cp1x = nuber2Fixed(point.cp1.x/width);
//         const cp1y = nuber2Fixed((height-point.cp1.y)/height);
//         const cp2x = nuber2Fixed(point.cp2.x/width);
//         const cp2y = nuber2Fixed((height-point.cp2.y)/height);
